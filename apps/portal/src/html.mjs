...
export function loginPage({ nonce, csrf, next = '/', error = '' }) {
  return shell({
  ...
  return shell({
    ...
    <main class="wrap">
      ...
      <section class="games" aria-label="Game categories">
        <article class="game"><p class="eyebrow">Territory</p><h3>Weiqi · Go</h3><p>Shape, liberties, tactical reading, ownership evidence, and full-board reflection.</p><div class="links"><a href="/weiqi/?view=learn&amp;board=19">19 × 19</a><a href="/weiqi/?view=learn&amp;board=9">9 × 9</a><a href="/weiqi/?view=learn&amp;board=7">7 × 7</a></div></article>
